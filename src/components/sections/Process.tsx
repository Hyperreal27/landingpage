        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              <span className="text-[#F57F11] font-semibold">AI Infrastructure</span>{' '}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {processSteps.map((step, index) => (
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="bg-black/90 border border-[#F57F11]/20 rounded-2xl p-8 hover:border-[#F57F11]/40 transition-all duration-300 hover:shadow-lg hover:shadow-[#F57F11]/10 text-center space-y-6 relative">
                    {/* Step number */}
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <div className="w-8 h-8 bg-[#F57F11] rounded-full flex items-center justify-center text-white font-bold text-sm">
                        {index + 1}
                      </div>
                    </div>
                    ...
                    <div className="flex justify-center pt-4">
                      <div className="w-16 h-16 bg-[#F57F11]/10 rounded-xl flex items-center justify-center">
                        <step.icon className="w-8 h-8 text-[#F57F11]" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#F57F11]/10 text-[#F57F11] text-sm">
                  ...
                  {index < processSteps.length - 1 && (
                    <div className="hidden md:block absolute top-1/2 -right-4 w-8 h-px bg-gradient-to-r from-[#F57F11] to-transparent transform -translate-y-1/2" />
                  )}
                </motion.div>
              ))}
            </div>
          ...
          <motion.div variants={itemVariants} className="text-center">
            <div className="bg-black/90 border border-[#F57F11]/20 rounded-2xl p-8 max-w-3xl mx-auto">
              <h3 className="text-2xl font-display font-bold text-white mb-4">
                ¿Listo para <span className="text-[#F57F11]">Automatizar</span> tu Negocio?
              </h3>
